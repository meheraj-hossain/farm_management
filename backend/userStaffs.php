...
$getStaffs = mysqli_query($con,"SELECT * FROM users WHERE role =2 ORDER BY id DESC");
?>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach ($getStaffs as $key=>$staff) { ?>
                    <tr>
                        <td><?php echo $key +1 ?></td>
                        <td><?=$staff['name']?></td>
                        <td><img src="<?=$staff['image']?>" alt="" style="max-width: 50px; max-height: 50px"></td>
                        <td><?=$staff['email']?></td>
                        <td><?=$staff['phone']?></td>
                        <td><?=$staff['address']?></td>
                    </tr>
