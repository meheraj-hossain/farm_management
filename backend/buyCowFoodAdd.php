...
if(isset($_POST['submit'])){
	...
	$_SESSION['bcf_food_id'] = $food_id; 
	
	//quantity
	$quantity = strip_tags($_POST['quantity']); 
	$quantity = str_replace(' ', '', $quantity); 
	$_SESSION['bcf_quantity'] = $quantity; 

	//unit_price
	$unit_price = strip_tags($_POST['unit_price']); 
	$unit_price = str_replace(' ', '', $unit_price); 
	$_SESSION['bcf_unit_price'] = $unit_price; 

	//entry_date
	$total_price = strip_tags($_POST['total_price']); 
	$total_price = str_replace(' ', '', $total_price); 
	$_SESSION['bcf_total_price'] = $total_price; 

	//buy_at
	$buy_at = strip_tags($_POST['buy_at']); 
	$_SESSION['bcf_buy_at'] = $buy_at; 		
    
	

	if(empty($errorMessage)){		
		$insert = mysqli_query($con, "INSERT INTO cow_food_expenses VALUE('', '$food_id', '$quantity','$unit_price', '$total_price','$buy_at')");
		if ($insert) {
			...
			$_SESSION['bcf_food_id'] = "";
			$_SESSION['bcf_quantity'] = "";
			$_SESSION['bcf_unit_price'] = "";
			$_SESSION['bcf_total_price'] = "";
			$_SESSION['bcf_buy_at'] = "";
		}else{
	        ...
	        <div class="row mb-2">
	          ...
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              ...
	              <li class="breadcrumb-item active">Cow Food Expens Add</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
		          ...
		          <div class="col-md-12">
		            ...
		            <div class="card card-info">
		              <div class="card-header">
		                <h3 class="card-title">Cow Food Expens Add</h3>
		              </div>
		              <!-- /.card-header -->
		              <!-- form start -->
		              <form class="form-horizontal" action="" method="POST">
		                <div class="card-body">
			                        	...
			                        	<option value="">Select Food</option>
			                          	<?php
											...
											foreach ($cow_foods as $key => $cf) {
												$cfood_id = $cf['id'];
												$cfood_name = $cf['name'];
												if (isset($_SESSION['bcf_food_id']) && $_SESSION['bcf_food_id']==$food_id) {
		                	...
		                	<div class="form-group row">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="number" min="0" step="0.01" name="quantity" class="form-control" id="quantity" placeholder="Quantity" value="<?php if(isset($_SESSION['bcf_quantity'])) { echo $_SESSION['bcf_quantity']; }  ?>" oninput="calculate()">
			                    </div>
			                </div>
			                ...
			                <div class="form-group row">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="number" min="0" name="unit_price" class="form-control" id="unit_price" placeholder="Unit Price" value="<?php if(isset($_SESSION['bcf_unit_price'])) { echo $_SESSION['bcf_unit_price']; }  ?>" oninput="calculate()">
			                    </div>
			                </div>
			                ...
			                <div class="form-group row">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="number" min="0" name="total_price" class="form-control" id="total_price" placeholder="Total Price" value="<?php if(isset($_SESSION['bcf_total_price'])) { echo $_SESSION['bcf_total_price']; }  ?>" readonly>
			                    </div>
			                </div>
			                ...
			                <div class="form-group row">
			                    ...
			                    <div class="col-sm-10">
			                      <input type="text" name="buy_at" class="form-control" id="buy_date" placeholder="Entry Date" value="<?php if(isset($_SESSION['bcf_buy_date'])) { echo $_SESSION['bcf_buy_date']; }  ?>">
			                    </div>
			                </div>		                
