...
$cowFoods = mysqli_query($con,"SELECT * FROM cow_food_expenses ORDER BY id DESC");
?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><?=$CF['quantity']?></td>
                        <td><?=$CF['unit_price']?> BDT</td>
                        <td><?=$CF['total_price']?> BDT</td>
                        <td><?=$CF['buy_at']?></td>
                        <td>
                          <a class="action-btn-warning" href="buyCowFoodEdit.php?BCF_id=<?=$CF['id']?>">
